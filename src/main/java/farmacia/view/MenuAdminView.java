...
public class MenuAdminView {
    ...
    /**
     * Exibe o menu e aguarda ações até o usuário fazer logout.
     */
    public void exibir() {
        while (true) {
            ...
            switch (opcao) {
                ...
                case 5 -> new VendaView(admin, vendaController, clienteController).registrarVenda();
                case 6 -> new VendaView(admin, vendaController, clienteController).listarVendas();
                case 0 -> {
